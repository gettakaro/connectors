...
- `mod/TakaroTerrariaEvents` — a server-side TShock plugin that emits structured
...
```bash
games/terraria/scripts/build-release.sh 0.1.0 dist
```
...
```bash
games/terraria/scripts/build-bridge-release.sh 0.1.0 dist
```
