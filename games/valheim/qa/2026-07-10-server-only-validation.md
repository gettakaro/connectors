...
dotnet test games/valheim/mod/Takaro.Valheim.sln --no-restore -v minimal
bash games/valheim/tests/setup-environment-behavior.sh
```
...
dotnet test games/valheim/mod/Takaro.Valheim.sln --no-restore -v minimal
bash games/valheim/tests/setup-environment-behavior.sh
dotnet build games/valheim/mod/src/Takaro.Valheim.Plugin/Takaro.Valheim.Plugin.csproj \
...
bash games/valheim/scripts/build-release.sh 0.0.0-dev /tmp/valheim-turn2-release
```
