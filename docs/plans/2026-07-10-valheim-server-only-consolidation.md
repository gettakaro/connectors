...
- Tasks 3-5 were implemented through turn 9. Turn 10 addresses two independent turn-9 severity-8 findings without changing the dedicated-server-only or unsupported-client-state boundary: all request/lifecycle adapter access is marshalled through a bounded Unity-main-thread queue, and writable Steam depots are isolated to an explicitly owned compile-reference cache.
- Task 6 turn-9 local gates passed `174/174` tests, `26/26` setup scenarios, real `net472`, stable/prerelease packaging, and the locale/source-immutability matrix. Exact prerelease ZIP `1fa0ac9eb9bc7ca0f5b2cc296eff1df7abefdb8402f20e5fbaa226c93bf99f51` and plugin `5c7728ffbdd33844547f7aa5f9d921b9c698f3b2d22cf5c684a54bc8c0e7466f` loaded as BepInEx `7.8.9`. Turn-10 source requires fresh build/package verification.
- Task 7 safe live QA passed for exact turn-9 source commit `0a008863d4761a7865c97efdc88bd598204a978d`, game server `4dadfdf6-18a3-41f1-ae2c-b94200dea9ab`, real location `140/33/-2`, lifecycle events `55ab985e-d0e2-4b6b-9d0a-8c3df7d365dd` and `8688cb9f-3540-4e34-b355-4a0aa52d69b8`, and outbound acting-user chat record `53026329-cdd3-4d81-b6ea-d321931c47fb`. Destructive actions remained skipped. Evidence is sanitized under `/tmp/valheim-turn9-evidence`.
- Task 8 turn-9 exerciser passed and exact Codex session `019f5004-5dcb-7751-9693-fea212ea19a8` completed, but verification failed on the background Unity access and live-tree replacement findings. Turn-10 independent verification, PR creation, GitHub Actions, superseded-PR closure, merge, and release-PR refresh remain pending. None is claimed complete here.
